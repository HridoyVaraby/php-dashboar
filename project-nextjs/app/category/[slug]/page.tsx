...
export default function CategoryPage() {
    ...
    const { data, isLoading, error } = useCategory(slug, subcategorySlug || undefined, page, limit);
    ...
    const displayName = subcategorySlug ? data?.subcategory?.name : data?.category?.name;
    const displayDescription = subcategorySlug
        ? `${data?.category?.name} > ${data?.subcategory?.name} বিভাগের সকল সংবাদ`
        : `${data?.category?.name} বিভাগের সকল সংবাদ`;
